...
namespace Flame.Saves
{
    /// <summary>
    /// データを一時的に保持しておくクラス
    /// https://qiita.com/tocoteron/items/b865edaa0e3018cb5e55#databank
    /// </summary>
    public class DataBank
    {
        ...
        public string SavePath { get { return fullPath; } }

        DataBank() { }

        public static DataBank Open() { return instance; }

        public bool IsEmpty() { return bank.Count == 0; }

        public bool ExistsKey(string key) { return bank.ContainsKey(key); }
